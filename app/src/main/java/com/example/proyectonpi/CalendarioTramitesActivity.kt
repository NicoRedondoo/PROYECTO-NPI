...
class CalendarioTramitesActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_calendario_tramites) // Vincula el archivo XML
        ...
        try {
            ...
            webView.loadUrl("https://docs.google.com/gview?embedded=true&url=https://etsiit.ugr.es/sites/centros/etsiit/public/inline-files/PLAZOS%20DE%20INTERES%20CURSO%202024-25.pdf")
